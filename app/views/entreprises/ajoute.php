...
<div class="navbar dark">
  ...
  <div class="col-8 mt-5">
    ...
    <form style="margin-top:7%" action="<?php echo URLROOT; ?>/entreprises/ajoute" method="post">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="siegeetreprise" name="adresse" aria-describedby="emailHelp">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="siegeetreprise" name="prenom_nom_repondtant" aria-describedby="emailHelp">
        <span class="invalidFeedback"><?php echo $data["prenom_nom_repondtantError"]; ?></span>
      </div>
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Telephone</label>
        <input type="text" class="form-control" id="Telephoneetreprise" name="telel" aria-describedby="emailHelp">
        <span class="invalidFeedback"><?php echo $data["telelError"]; ?></span>
      </div>
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">NINEA</label>
        <input type="text" class="form-control" id="siegeetreprise" name="niena" aria-describedby="emailHelp">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="siegeetreprise" name="nombreEnployer" aria-describedby="emailHelp">
        <span class="invalidFeedback"><?php echo $data["nombreEnployerError"]; ?></span>
      </div>
      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" name="organigrame" id="organigramme" value="1">
        <label class="form-check-label" for="exampleCheck1">Avez-vous un organigramme ?</label>
      </div>

      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" name="cautisationsocial" value="1" id="dispositifFormation">
        <label class="form-check-label" for="exampleCheck1">Avez-vous un Dispositif de cotisation social ?</label>
      </div>

      <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" name="pqgeWep" id="pqgeWep" value="1">
        <label class="form-check-label" for="exampleCheck1">Avez-vous un page wep ?</label>
      </div>
